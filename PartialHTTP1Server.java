...
class Task implements Runnable {
    ...
    ///////this kind of works. you it processes it if its a cgi file and sends it to the server for parsing,
    // to POST
	public void ProcessCgi(String CGI_File,OutputStream ToBrowser,int CGI_PROG )
    		throws IOException{
    	...
    	/*
    	 ...
    	 Process p=r.exec(CGI_File);			//win32 process initialised to null
    	 /*
    	 switch(CGI_PHP){
